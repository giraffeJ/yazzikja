    ...
    fun createAndLoginEmail(){
        auth?.createUserWithEmailAndPassword(email_edittext.text.toString(),password_edittext.text.toString())?.addOnCompleteListener {
            ...
            if(task.isSuccessful){
                ...
                Toast.makeText(this, "아이디 생성 및 로그인이 완료되었습니다.", Toast.LENGTH_LONG).show()
            }else if(task.exception?.message!= null && task.exception?.message!="The email address is already in use by another account."){
